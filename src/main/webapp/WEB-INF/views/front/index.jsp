  ...
  <c:forEach items="${lunboAd}" var="ad">
    ...
    <div class="container section-search Fix">
      <div class="result">
        ...
        <div class="block">
          <div class="search"><span class="icon-search"></span>
            <input type="text" placeholder="搜索国家、城市、景点" class="input J_search-city" data-url="${ctx}/front/search/dest.json">
      ...
      <div class="select">
        ...
        </ul><a href="${ctx}/front/search/toList" data-url="${ctx}/front/search/toList" id="J_to-list" class="btn-view">查看商品</a>
      </div>
    </div>
