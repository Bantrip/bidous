...
insert into product(id,name,category_id, recommand , status ,  price, merchant_id,url,stock)values(1,'商品1',null,'不买是傻逼',1,22.3,null,'http://www.yhd.com',0);
insert into product(id,name,category_id, recommand , status ,  price, merchant_id,url,stock)values(2,'商品2',null,'不买是傻逼是傻逼',1,22.3,null,'htp://www.yhd.com',0);
